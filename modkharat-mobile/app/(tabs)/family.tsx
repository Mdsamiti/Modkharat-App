...
import { Users, TrendingUp, TrendingDown, Target, Settings, Plus } from 'lucide-react-native';
import { useTranslation } from 'react-i18next';
import AppHeader from '@/components/AppHeader';
import { useApp } from '@/context/AppContext';
import { mockFamilyMembers, mockSharedGoals, mockSharedBudgets } from '@/services/mock/data';
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View className="flex-row justify-between">
            <View>
              <Text className="text-blue-100 text-xs">{t('family.combinedIncome')}</Text>
              <Text className="text-white text-xl font-bold">{currency} 24,500</Text>
            </View>
            <View className="items-end">
              <Text className="text-blue-100 text-xs">{t('family.familySpending')}</Text>
              <Text className="text-white text-xl font-bold">{currency} 15,730</Text>
            </View>
          </View>
        </LinearGradient>
